 ...
 */
public class MoveBehaviorDefaultTest extends TestWithDummyBoard {

    @Inject
    private MoveBehaviorDefault move;
    ...
    public void testMoveThroughWall() {
        // a wall
        Assert.assertFalse(move.canMove(getField(0, 4), getField(0, 3)));
        Assert.assertFalse(move.canMove(getField(0, 3), getField(0, 4)));
    }

    @Test
    public void testMoveThroughDoor() {
        // a closed door
        Assert.assertFalse(move.canMove(getField(1, 3), getField(1, 4)));
        Assert.assertFalse(move.canMove(getField(1, 4), getField(1, 3)));
        // open the door
