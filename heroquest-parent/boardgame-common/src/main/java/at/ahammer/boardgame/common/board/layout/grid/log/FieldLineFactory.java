...
/**
 * Factory class to create all {@link FieldLine}s for a {@link
 * at.ahammer.boardgame.api.board.field.Field}.
 * <p/>
 * The creation ({@link FieldLineUsage#create(FieldLineFactory.State)})
 * and order ({@link FieldLineUsage#rank()}) of a concrete {@link FieldLine}
 * is handled by it's {@link FieldLineUsage}.
 * <p/>
 * The maximum width of the {@link FieldLine} is defined by {@link
 * FieldLine#WIDTH}.
 * <p/>
 * The maximum number of {@link FieldLine}s is defined by {@link
 * FieldLine#HEIGHT}.
 * <p/>
...
public class FieldLineFactory {
    ...
    /**
     * Create all {@link FieldLine}s for the {@link
     * at.ahammer.boardgame.api.board.field.Field}.
     *
     * @param field
    ...
    /**
     * Get all {@link FieldLineUsage} sorted by {@link
     * FieldLineUsage#rank()}.
     *
     * @return a sorted {@link java.util.List} of {@link FieldLineUsage}
     */
    ...
    /**
     * This class holds the state for the creation of all {@link FieldLine}s
     * of a {@link FieldRepresentation}.
     */
    public static class State {
        ...
        /**
         * Get a sorted {@link java.util.List} of all available {@link FieldLineUsage}s.
         *
         * @return a sorted {@link java.util.List} of all available {@link FieldLineUsage}s
         */
