...
/**
 * The {@link at.ahammer.boardgame.api.subject.hand.Hand.Type#MAIN} can use {@link
 * at.ahammer.boardgame.api.artifact.weapon.WeaponType#ONE_HAND_ATTACK}.
 * <p/>
 * A one-handed-weapon will be added to the main-hand.
 */
@ApplicationScoped
public class OneHandedWeapon extends ArtifactHandlingStrategyBasic {
