 ...
 * {@link #run(BeanManager, org.jabogaf.api.cdi.RunInGameContext)}.
 * <p/>
 * To reuse an existing context use {@link #run(UUID, BeanManager, org.jabogaf.api.cdi.RunInGameContext)}
 *
 * @author Andreas
 */
@Singleton
public class GameContext implements Context {
    ...
    /**
     * The {@link Stack} which holds the {@link GameContext}.
     */
