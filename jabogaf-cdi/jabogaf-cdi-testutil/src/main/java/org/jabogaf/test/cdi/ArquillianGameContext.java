...
/**
 * A JUnit-TestRunner for Arquillian-Test with an active {@link org.jabogaf.api.cdi.GameScoped}.
 * <p/>
 * If the underlying test-class extends {@link ArquillianGameContextTest}, then all methods run within a new {@link
 * org.jabogaf.api.cdi.GameScoped}.
 * <p/>
 * This class will also add all classes defined in {@link ActivateAlternatives} to the {@link
 * org.jabogaf.api.cdi.AlternativesInGameContext}, so these alternatives will be activated for
