 ...
 * annotation {@link org.jabogaf.api.cdi.GameScoped} will be unique in this context.
 * <p/>
 * To start the context use
 * {@link #run(javax.enterprise.inject.spi.BeanManager, org.jabogaf.api.cdi.RunInGameContext)}.
 * <p/>
 * To reuse an existing context use {@link #run(java.util.UUID, javax.enterprise.inject.spi.BeanManager, org.jabogaf.api.cdi.RunInGameContext)}
 *
 * @author Andreas
 */
@Singleton
public class GameContext implements Context {
     ...
     *
     * @param runnable - the {@link org.jabogaf.api.cdi.RunInGameContext} which code must run within a
     *                 {@link GameContext}
     * @return the result of the {@link org.jabogaf.api.cdi.RunInGameContext}
     */
