...
public abstract class GameContextBeanBasic implements GameContextBean {
    ...
    /**
     * Create a new {@link org.jabogaf.core.cdi.GameContextBeanBasic} with a random id. The bean will also be
    ...
    /**
     * Create a new {@link org.jabogaf.core.cdi.GameContextBeanBasic}. The bean will also be registered in
     * GameContext via {@link org.jabogaf.api.cdi.GameContextManager}.
     * <p/>
     * Always fire an event of {@link GameStateChanged}.
     *
     * @param id the id of the {@link org.jabogaf.core.cdi.GameContextBeanBasic}.
     */
