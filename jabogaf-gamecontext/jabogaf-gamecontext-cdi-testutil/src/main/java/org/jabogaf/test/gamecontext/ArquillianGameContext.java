...
/**
 * A JUnit-TestRunner for Arquillian-Test with an active {@link GameScoped}.
 * <p>
 ...
 * AlternativesInGameContext}, so these alternatives will be activated for <strong>every</strong> test-method.
 */
