...
// */
//@GameScoped
//public class MoveableFields2 extends CachedValueMap<List<MovePath>, MoveableFields2.Parameter> {
//
//    @Inject
...
//    }
//
//    private void checkFieldsToResolve(ResolvedField resolvedField, Parameter parameter) {
...
//            CanMoveReport canMoveReportToPossibleField = canMoveReport(parameter, resolvedField, possibleFieldToResolve);
...
//    }
//
//    private CanMoveReport canMoveReport(Parameter parameter, Field position, Field target) {
//        return parameter.getClonedMoveable(position).canMove(target, new ResourcesBasic());
//    }
//
...
//            checkFieldsToResolve(firstResolvedField, parameter);
...
//                        checkFieldsToResolve(resolvedField, parameter);
//                    }
//                }
//            }
...
//
//        private final MoveableWrapper moveableWrapper;
//
...
//            this.moveableWrapper = new MoveableWrapper(moveable);
//        }
//
//        public Moveable getMoveable() {
//            return moveableWrapper.getMoveable();
//        }
//
...
//            moveableWrapper.getSetterForPositionOfCloneable().setPosition(position);
//            return moveableWrapper.getClonedMoveable();
//        }
//
//        @Override
//        public boolean equals(Object o) {
...
//
//            return resourceHolder.equals(parameter.resourceHolder) && moveableWrapper.equals(parameter.moveableWrapper);
//
//        }
//
//        @Override
//        public int hashCode() {
//            int result = resourceHolder.hashCode();
//            result = 31 * result + moveableWrapper.hashCode();
//            return result;
//        }
//    }
//
