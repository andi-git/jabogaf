...
/**
 * All the {@link Field}s of a board are arranged by a concrete layout. So the
 * layout defines the available {@link Field}s, how the {@link Field}s are connected via {@link FieldConnection}s
 * and grouped via {@link FieldGroup}.
 */
public interface Layout extends GameContextBean {
     ...
     * @return a {@link Set} of {@link FieldConnection}s that are between the look from a position {@link Field} to the target {@link Field}.
     */
