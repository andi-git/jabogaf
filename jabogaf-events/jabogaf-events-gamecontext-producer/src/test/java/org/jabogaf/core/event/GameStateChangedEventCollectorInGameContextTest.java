...
public class GameStateChangedEventCollectorInGameContextTest {
    ...
    public void testGameStateChangedEventGroupHandler() throws Throwable {
        ...
        gameContextManager.runInGameContext(beanManager, gameContextId -> {
            ...
            assertFalse(gameStateChangedEventCollector.getGameStateChangedEventGroups().isEmpty());
            assertEquals(1, gameStateChangedEventCollector.getGameStateChangedEventGroups().size());
            assertEquals(1, gameStateChangedEventCollector.getGameStateChangedEventGroupsOrderedByTime().get(0).getGameStateChangedEvents().size());
